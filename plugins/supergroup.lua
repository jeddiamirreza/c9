...
local function unlock_group_all(msg, data, target)
  ...
  local group_all_lock = data[tostring(target)]['settings']['all']
  if group_all_lock == '☑️' then
    return 'all setting is not locked'
  else
    data[tostring(target)]['settings']['all'] = '☑️'
    save_data(_config.moderation.data, data)
...
local function unlock_group_etehad(msg, data, target)
  ...
  local group_etehad_lock = data[tostring(target)]['settings']['etehad']
  if group_etehad_lock == '☑️' then
    return 'etehad setting is not locked'
  else
    data[tostring(target)]['settings']['etehad'] = '☑️'
    save_data(_config.moderation.data, data)
...
local function unlock_group_leave(msg, data, target)
  ...
  local group_leave_lock = data[tostring(target)]['settings']['leave']
  if group_leave_lock == '☑️' then
    return 'leave is not locked'
  else
    data[tostring(target)]['settings']['leave'] = '☑️'
    save_data(_config.moderation.data, data)
...
local function unlock_group_operator(msg, data, target)
  ...
  local group_operator_lock = data[tostring(target)]['settings']['operator']
  if group_operator_lock == '☑️' then
    return 'operator is not locked'
  else
    data[tostring(target)]['settings']['operator'] = '☑️'
    save_data(_config.moderation.data, data)
...
local function unlock_group_reply(msg, data, target)
  ...
  local group_reply_lock = data[tostring(target)]['settings']['reply']
  if group_reply_lock == '☑️' then
    return 'reply is not locked'
  else
    data[tostring(target)]['settings']['reply'] = '☑️'
    save_data(_config.moderation.data, data)
...
local function unlock_group_username(msg, data, target)
  ...
  local group_username_lock = data[tostring(target)]['settings']['username']
  if group_username_lock == '☑️' then
    return 'username is not locked'
  else
    data[tostring(target)]['settings']['username'] = '☑️'
    save_data(_config.moderation.data, data)
...
local function unlock_group_media(msg, data, target)
  ...
  local group_media_lock = data[tostring(target)]['settings']['media']
  if group_media_lock == '☑️' then
    return 'media is not locked'
  else
    data[tostring(target)]['settings']['media'] = '☑️'
    save_data(_config.moderation.data, data)
...
local function unlock_group_fosh(msg, data, target)
  ...
  local group_fosh_lock = data[tostring(target)]['settings']['fosh']
  if group_fosh_lock == '☑️' then
    return 'fosh is not locked'
  else
    data[tostring(target)]['settings']['fosh'] = '☑️'
    save_data(_config.moderation.data, data)
...
local function unlock_group_join(msg, data, target)
  ...
  local group_join_lock = data[tostring(target)]['settings']['join']
  if group_join_lock == '☑️' then
    return 'join is not locked'
  else
    data[tostring(target)]['settings']['join'] = '☑️'
    save_data(_config.moderation.data, data)
...
local function unlock_group_fwd(msg, data, target)
  ...
  local group_fwd_lock = data[tostring(target)]['settings']['fwd']
  if group_fwd_lock == '☑️' then
    return 'fwd is not locked'
  else
    data[tostring(target)]['settings']['fwd'] = '☑️'
    save_data(_config.moderation.data, data)
...
local function unlock_group_english(msg, data, target)
  ...
  local group_english_lock = data[tostring(target)]['settings']['english']
  if group_english_lock == '☑️' then
    return 'english is not locked'
  else
    data[tostring(target)]['settings']['english'] = '☑️'
    save_data(_config.moderation.data, data)
...
local function unlock_group_emoji(msg, data, target)
  ...
  local group_emoji_lock = data[tostring(target)]['settings']['emoji']
  if group_emoji_lock == '☑️' then
    return 'emoji is not locked'
  else
    data[tostring(target)]['settings']['emoji'] = '☑️'
    save_data(_config.moderation.data, data)
...
local function unlock_group_tag(msg, data, target)
  ...
  local group_tag_lock = data[tostring(target)]['settings']['tag']
  if group_tag_lock == '☑️' then
    return 'tag is not locked'
  else
    data[tostring(target)]['settings']['tag'] = '☑️'
    save_data(_config.moderation.data, data)
...
local function unlock_group_arabic(msg, data, target)
  ...
  local group_arabic_lock = data[tostring(target)]['settings']['lock_arabic']
  if group_arabic_lock == '☑️' then
    return 'Arabic/Persian is already unlocked'
  else
    data[tostring(target)]['settings']['lock_arabic'] = '☑️'
    save_data(_config.moderation.data, data)
...
local function unlock_group_rtl(msg, data, target)
  ...
  local group_rtl_lock = data[tostring(target)]['settings']['lock_rtl']
  if group_rtl_lock == '☑️' then
    return 'RTL is already unlocked'
  else
    data[tostring(target)]['settings']['lock_rtl'] = '☑️'
    save_data(_config.moderation.data, data)
...
local function unlock_group_tgservice(msg, data, target)
  ...
  local group_tgservice_lock = data[tostring(target)]['settings']['lock_tgservice']
  if group_tgservice_lock == '☑️' then
    return 'TgService Is Not Locked!'
  else
    data[tostring(target)]['settings']['lock_tgservice'] = '☑️'
    save_data(_config.moderation.data, data)
...
local function unlock_group_sticker(msg, data, target)
  ...
  local group_sticker_lock = data[tostring(target)]['settings']['lock_sticker']
  if group_sticker_lock == '☑️' then
    return 'Sticker posting is already unlocked'
  else
    data[tostring(target)]['settings']['lock_sticker'] = '☑️'
    save_data(_config.moderation.data, data)
...
local function unlock_group_contacts(msg, data, target)
  ...
  if group_contacts_lock == '☑️' then
    return 'Contact posting is already unlocked'
  else
    data[tostring(target)]['settings']['lock_contacts'] = '☑️'
    save_data(_config.moderation.data, data)
...
local function disable_strict_rules(msg, data, target)
  ...
  local group_strict_lock = data[tostring(target)]['settings']['strict']
  if group_strict_lock == '☑️' then
    return 'Settings are not strictly enforced'
  else
    data[tostring(target)]['settings']['strict'] = '☑️'
    save_data(_config.moderation.data, data)
...
local function unset_public_membermod(msg, data, target)
  ...
  if group_public_lock == '☑️' then
    return 'Group is not public'
  else
    data[tostring(target)]['settings']['public'] = '☑️'
